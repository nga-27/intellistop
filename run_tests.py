...
# test_time_series.test_ts_1(use_derived=True)
# test_time_series.test_ts_1("VGT")
# test_time_series.test_ts_1("VGT", use_derived=True)
# test_time_series.test_ts_1("VHT")
# test_time_series.test_ts_1("VHT", use_derived=True)
# test_time_series.test_ts_1("VXUS")
# test_time_series.test_ts_1("VXUS", use_derived=True)
# test_time_series.test_ts_1("VO")
# test_time_series.test_ts_1("VO", use_derived=True)
# test_time_series.test_ts_1("VNQ")
# test_time_series.test_ts_1("VNQ", use_derived=True)
test_time_series.test_ts_1("SPY")
test_time_series.test_ts_1("SPY", use_derived=True)
